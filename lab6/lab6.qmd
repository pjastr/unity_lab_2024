...
1. W ustawieniach projektu dodaj co najmniej jeden obrazek jako SplashImage.
...
Stwórz scenę Menu i dodaj tam kilka przycisków. Potestuj różne umiejscowieniem go względem pozycji, anchor, pivot. Skompiluj projekt przy wybranych ustawieniach.

## Ćw.3. - Ustawienia

Umieść dotychczasowe przyciski na panelu (dalsze przyciski będą dziećmi w hierarchii). Dodaj do przysisku ustawienia logikę tak, aby główny panel znikał, a pojawiał się inny do sterowania ustawieniami.
...
Stwórz prostą logikę do sterowania ustawieniami np. rozdzielczością (ale mogą być inne opcje). Upewnij się, ze masz zaimplementowany powrót to głównego menu.
...
* usuń horyzontal scrollbar z hierarchii. Odhacz tez dla ScrollView horizontal.
...
* Zmień parametry obiektu Content. W Rect Transform wobec obu osi ustaw scretch. Dodaj komponent TextMeshPro - Text (UI). W Extra Setting ustaw marginesy. Dodaj komponent Content Size Fitter. 
...
* Można poprawić esetetykę prawo scrola. Pozycja RectTransform + lekkie ręczne przesunięcie.

![](images/f10.png)

## Ćw.5. - Nawigacja do kolejnych scen

Dodaj do projektu nawigację do kolejnych scen. Upewnij się, że sceny są ujęte w Build Setting.
